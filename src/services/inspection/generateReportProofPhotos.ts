...
const styleHTML = `
  <style>
    ...
    .register-item { background-color: #eee; display: flex; flex-direction: column; gap: 15px; padding: 10px; border-radius: 16px; margin-bottom: 10px; width: 200px; height: 200px; }
    .register-item_img { width: 200px; height: 200px; border-radius: 16px; object-fit: cover; }
