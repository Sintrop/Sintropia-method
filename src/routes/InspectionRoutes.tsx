...
import { AreaDBProps, SamplingDBProps } from '../types/database';
import { InspectorReportScreen } from '../screens/inspection/InspectorReportScreen/InspectorReportScreen';
...
export type InspectionStackParamsList = {
  ...
  InspectorReportScreen: undefined;
};
...
export function InspectionRoutes() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen
        name="RealizeInspectionScreen"
        component={RealizeInspectionScreen}
      />
      ...
      <Stack.Screen
        name="InspectorReportScreen"
        component={InspectorReportScreen}
      />
    </Stack.Navigator>
  );
}
